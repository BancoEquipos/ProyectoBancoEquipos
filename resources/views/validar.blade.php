    ...
    <div class="container-fluid">
        ...
        <div clas="row">
            ...
            <div class="col-12 col-md-9 divInfo">
                <h3 class="h3 mb-3 fw-normal textoTitulo">Aqui podrá ver las solicitudes de material realizadas por los alumnos. Están ordenadas de más nuevas a más antiguas.</h3>
            </div>
        </div>
