...
<body>
  ...
  <nav class="navbar">
    ...
    <button class="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target=""
      ...
      <img src="/prestamo/Imagenes/volver.svg" width="65" height="70">
    </button>
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link opcionUsuario">Cambiar cuenta</a>
        </li>
        <li class="nav-item ">
          <a class="nav-link opcionUsuario" style="margin-right: -17px;">Cerrar sesión</a>
        </li>
    ...
    <div class="main">
      ...
      <div class="row">
        ...
        <div class=" mensajeOculto" id="emailError">
            ...
            murciaeduca "f@alu.murciaeduca.es".
        </div>
      </div>
      ...
      <div class="form-floating separador col-12 col-lg-6">
        <select class="form-select" aria-label="Default select example" id="gradoSelect">
          <option selected value="Defecto">Seleccione el grado que esté cursando</option>
        </select>
      </div>

      <div class="form-floating separador col-12 col-lg-6">
        <select class="form-select" aria-label="Default select example" id="cursoSelect">
          <option selected value="Defecto">Seleccione su curso</option>
      ...
      <div class="form-floating separador col-12 col-lg-6">
        <select class="form-select" id="motivoSelect">
          <option selected value="Defecto">Seleccione el motivo de su solicitud</option>
        </select>
      </div>
